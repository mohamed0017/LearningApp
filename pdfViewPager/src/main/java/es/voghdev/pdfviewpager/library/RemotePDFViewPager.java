...
public class RemotePDFViewPager extends ViewPager implements DownloadFile.Listener {
    ...
    public DownloadFileUrlConnectionImpl customDownloadFile;
    ...
    public RemotePDFViewPager(Context context, String pdfUrl, DownloadFile.Listener listener) {
        ...
        customDownloadFile  = new DownloadFileUrlConnectionImpl(context, new Handler(), this);

        init(customDownloadFile, pdfUrl);
    }

    public void interruptDownloadThread(){
        customDownloadFile.downloadThread.interrupt();
    }
